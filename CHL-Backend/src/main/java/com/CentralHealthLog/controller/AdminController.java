...
//    }
    ...
    @GetMapping(value = "/to-be-registered",produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity <List<Doctor>> get_all_to_be_registered_doctors(){
        List<Doctor> doctors = service.get_all_to_be_registered_Doctors();
